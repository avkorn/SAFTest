...
public class SafActivityResult <Input, Result> {
     ...
     */
    @NonNull
    public static <Input, Result> SafActivityResult<Input, Result> registerForActivityResult(
            @NonNull ActivityResultCaller caller,
            @NonNull ActivityResultContract<Input, Result> contract,
            @Nullable OnActivityResult<Result> onActivityResult) {
        return new SafActivityResult<>(caller, contract, onActivityResult);
    }
     ...
     */
    @NonNull
    public static SafActivityResult<Intent, ActivityResult> registerActivityForResult(
            @NonNull ActivityResultCaller caller) {
